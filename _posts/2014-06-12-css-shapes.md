...
##Where can I learn more?
  ...
  * If you have a browser with support for [CSS Regions](/css-regions/), our [National Geographic Forest Giant Demo](http://webplatform.adobe.com/Demo-for-National-Geographic-Forest-Giant/browser/src/){:target="_blank"} has many compelling uses of CSS Shapes in the context of a magazine article.
